...
@description('Neon Serverless Postgres Host')
param neonServerlessPostgresHost string // Set in main.parameters.json

@description('Neon Serverless Postgres Username')
param neonServerlessPostgresUserName string // Set in main.parameters.json

@description('Neon Serverless Postgres Password')
@secure()
param neonServerlessPostgresPassword string // Set in main.parameters.json
...
var webAppEnv = union(azureOpenAIKeyEnv, openAIComKeyEnv, [
  {
    name: 'POSTGRES_HOST'
    value: neonServerlessPostgresHost
  }
  {
    name: 'POSTGRES_USERNAME'
    value: neonServerlessPostgresUserName
  }
  {
    name: 'POSTGRES_DATABASE'
    value: neonServerlessPostgresDatabase
  }
  {
    name: 'POSTGRES_PASSWORD'
    value: neonServerlessPostgresPassword
  }
  {
    name: 'POSTGRES_SSL'
    value: 'require'
...
output POSTGRES_HOST string = neonServerlessPostgresHost
output POSTGRES_USERNAME string = neonServerlessPostgresUserName
output POSTGRES_DATABASE string = neonServerlessPostgresDatabase
